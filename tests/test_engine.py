...
#TODO: re-write engine tests in test_app.py
...
# def test_david_map():
#     go_hallway = Action(davids_room, 'geh in den flur', data_dict)
#     assert go_hallway.determine_action()['final_action'] == 'hallway'
